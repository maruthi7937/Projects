		...
		<div id="container"> 
			...
			<div id="content"> 
			   ...
			   <div style="clear: both;"></div>
		           ...
		           <table align="center">
				   <tr><td><a href='pchart/examples/pchart.php'>Pchart</a></td></tr>
				   <tr><td><a href='pchart/examples/barchart.php'>Barchart</a></td></tr>
				   </table>
		           <h1 align="center">Query Results list</h1>	
		           <table align="center">
 		           	<tr>
					<td>
	   				    	<?php
							...
							$line1 = "Select sample_id, percentage_removed from fastq_trimmer;";
					                
							$sql_result = mysqli_query($con, $line1) or die('Query failed line2');
