					...
					<td>
	   				    	<?php
	  				     		echo "<table align='left' border='1'>";	     
			 	   	                ...
			 	   	                $category = $_POST["category18"];
							
							if($category == "were")
							{
								$line1 = "select gene_id, sample_1, sample_2, significant from splicing where significant = 'no';";
								$line2 = "select gene_id significant from splicing where significant = 'no';";
	
									
							}

							else if($category == "werenot")
							{
								$line1 = "select gene_id, sample_1, sample_2, significant from splicing where significant = 'yes';";
								$line2 = "select gene_id significant from splicing where significant = 'yes';";
