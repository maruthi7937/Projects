					...
					<td>
	   				    	<?php
	  				     		echo "<table align='left' border='1'>";	     
			 	   	                ...
			 	   	                $category = $_POST["category19"];
							
							if($category == "do")
							{
								$line1 = "select gene_id, sample_1, sample_2, significant from promoter where significant = 'yes';";
								$line2 = "select gene_id significant from promoter where significant = 'yes';";	
	
									
							}

							else if($category == "donot")
							{
								$line1 = "select gene_id, sample_1, sample_2, significant from promoter where significant = 'no';";
								$line2 = "select gene_id significant from promoter where significant = 'no';";								
							...
							if(mysqli_num_rows($sql_result)>0)
						       ...
						       echo '<a href="results_download.php?execute='.$execute.'">Results</a>';
					     	       }
					       	       else
					   	       {
