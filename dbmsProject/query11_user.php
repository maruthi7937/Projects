			   ...
			   <div style="clear: both;"></div>
		           ...
		           <table align="center">
					...
					<td>
							...
							{
								$line1 = "SELECT gene_fpkm_id from gene_fpkm where chromosome = ".$value.";";
									
							}

							else if($category == "tss_fpkm")
							{
								$line1 = "SELECT tss_fpkm_id from tss_fpkm where chromosome = ".$value.";";
																	
							}
							else if($category == "isoform_fpkm")
							{
								$line1 = "SELECT isoform_id from isoform_fpkm where chromosome = ".$value.";";					
							}
