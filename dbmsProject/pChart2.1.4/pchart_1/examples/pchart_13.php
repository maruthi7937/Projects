<?php   
 ...
 $MyData = new pData();   
 $MyData->addPoints($count_gene,"ScoreA");    
 $MyData->setSerieDescription("ScoreA","Application A");

 /* Define the absissa serie */
 $MyData->addPoints($gene_id,"Labels");
 ...
 $myPicture->drawText(320,500,"distinct_gene_count",array("DrawBox"=>TRUE,"BoxRounded"=>TRUE,"R"=>0,"G"=>0,"B"=>0,"Align"=>TEXT_ALIGN_TOPMIDDLE));
 $myPicture->drawText(640,500,"gene_id / distinct_gene_count",array("DrawBox"=>TRUE,"BoxRounded"=>TRUE,"R"=>0,"G"=>0,"B"=>0,"Align"=>TEXT_ALIGN_TOPMIDDLE));
