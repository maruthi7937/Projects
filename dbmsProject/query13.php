	...
	<body>
		<div id="container"> 
			...
			<div id="content"> 
			   ...
			   <h1 align="center">Query Results In Graphical View</h1>	
		           <table align="center">
				   <tr><td><a href='pchart/examples/barchart_13.php'>Barchart</a></td></tr>
				   <tr><td><a href='pchart/examples/pchart_13.php'>Pie chart</a></td></tr>
				   </table>
					...
					<td>
	   				    	<?php
	  				     		echo "<table align='left' border='1'>";	     
			 	   	                ...
			 	   	                $category = $_POST["category13"];
							
							
							if($category == "all")
							{
								$line1 = "SELECT count(distinct g.gene_id) FROM gene_fpkm g WHERE g.sample_fpkm =  0 group by g.gene_id;";
							}
							else
							{
								$line1 = "SELECT count(distinct g.gene_id) FROM gene_fpkm g WHERE g.sample_fpkm = 0 AND g.sample_id = ".$category." group by g.gene_id;";
							}
